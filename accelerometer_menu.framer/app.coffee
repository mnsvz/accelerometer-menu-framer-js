...
#Declare some variables and controllers that we can use to tweak acceleration
accX = 0
accY = 0
accXsmooth = 0
accYsmooth = 0
...
#Create background and menu item layers
bg = new Layer
	size: Screen.size
...
#Function to acces device accelerometer and animate the menu based on the values
window.addEventListener "devicemotion", (event) ->
	...
	if accYsmooth < 4.0
		menuItems[0].animate
			...
			options:
				curve: Spring(tension:600, friction:10, velocity: 20)
		menuItems[1].animate
